...
states_poll_bias_scaler = .1
# .076 result in +- intotal 0.07585401
...
for(s in states) {
  ...
  # plinko
  start_dem <-
    floor(today_summary['dem'][[1]] * 100 / bin_width) * bin_width + trailer
  start_rep <-
    floor(today_summary['rep'][[1]] * 100 / bin_width) * bin_width  + trailer
  bin_n_dem <-
